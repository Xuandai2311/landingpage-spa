...
* **8-10 (Advanced Choreography):** Complex scroll-triggered reveals, parallax, scroll-triggered animations (CSS `animation-timeline` or GSAP ScrollTrigger). Use Motion hooks. **NEVER use `window.addEventListener('scroll')`** - it is a hard ban, not a "prefer-not." See Section 5.D for the allowed alternatives.

### VISUAL_DENSITY (Level 1-10)
* **1-3 (Art Gallery):** Lots of white space. Huge section gaps (`py-32` to `py-48`). Expensive, clean.
* **4-7 (Daily App):** Spacing typical of a dashboard or complex tool (`py-16` to `py-24`).
* **8-10 (Cockpit):** Spacing is packed. Grid lines divide data elements rather than boxes. Monospace is the default choice for all numbers and technical values.
...
### Appendix A: Install Command Reference
```bash
